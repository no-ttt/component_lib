...
const data = [
  ...
  <div style={{ display: "flex", justifyContent: "space-around" }}>
    <NearbySpot name={data[0].name} src={data[0].src} rating={data[0].rating} link={data[0].link} isLink={true} des="0.8 公里" />
    <NearbySpot name={data[1].name} src={data[1].src} rating={data[1].rating} des="8 則評論" />
  </div>
```