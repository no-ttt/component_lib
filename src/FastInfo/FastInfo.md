...
<div>
	<FastInfo spotName={info.ScenicSpotName} des={info.Description} phone={info.Phone} addr={info.Address} picture={info.Picture} open={info.OpenTime} ticket={info.TicketInfo} remark={info.Remarks} traffic={info.TravelInfo} pos={info.Position} />
</div>
```