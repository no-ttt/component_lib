...
const data = [
  ...
  <div style={{ display: "flex", justifyContent: "space-around" }}>
    <NearbySpot name={data[0].name} src={data[0].src} rating={data[0].rating} des={data[0].link} isLink={true} blank={true} />
    <NearbySpot name={data[0].name} src={data[0].src} rating={data[0].rating} des="0.8 公里" />
  </div>
```